Autoculture = {
  ...
  checkAvailable: function (_0xaa01x2) {
    ...
    if (
      _0xaa01x4['academy'] >= 30 &&
      _0xaa01x5['wood'] >= 15000 &&
      _0xaa01x5['stone'] >= 18000 &&
      _0xaa01x5['iron'] >= 15000
    ) {
      _0xaa01x3['party'] = true;
    }
    if (
      _0xaa01x4['theater'] == 1 &&
      _0xaa01x5['wood'] >= 10000 &&
      _0xaa01x5['stone'] >= 12000 &&
      _0xaa01x5['iron'] >= 10000
    ) {
  ...
  checkReady: function (_0xaa01x6) {
    ...
    if (
      _0xaa01x6['modules']['Autoculture']['isReadyTime'] >= Timestamp['now']()
    ) {
      return _0xaa01x6['modules']['Autoculture']['isReadyTime'];
    }
    if (
      Autoculture['settings']['towns'][_0xaa01x6['id']] !== undefined &&
      ((Autoculture['settings']['towns'][_0xaa01x6['id']]['party'] &&
        Autoculture['checkAvailable'](_0xaa01x6['id'])['party']) ||
        (Autoculture['settings']['towns'][_0xaa01x6['id']]['triumph'] &&
          Autoculture['checkAvailable'](_0xaa01x6['id'])['triumph']) ||
        (Autoculture['settings']['towns'][_0xaa01x6['id']]['theater'] &&
          Autoculture['checkAvailable'](_0xaa01x6['id'])['theater']))
    ) {
      return true;
    }
    return false;
        ...
        DataExchanger['building_place'](
          ...
          function (_0xaa01x8) {
            ...
            var _0xaa01xd = function (_0xaa01xe) {
              ...
              if (
                _0xaa01xe['element']['find']('#countdown_' + _0xaa01xe['name'])[
                  'length'
                ]
              ) {
                var _0xaa01xf = Autobot['timeToSeconds'](
                  _0xaa01xe['element']
                    ['find']('#countdown_' + _0xaa01xe['name'])
                    ['html']()
                );
                if (_0xaa01xc == 300) {
                  _0xaa01xc = _0xaa01xf;
    ...
    DataExchanger['start_celebration'](
      ...
      function (_0xaa01x8) {
        ...
        if (_0xaa01x8['json']['error'] == undefined) {
          var _0xaa01x13 = {};
          $['each'](
            _0xaa01x8['json']['notifications'],
            function (_0xaa01x14, _0xaa01x15) {
          ...
          if (Autoculture['town']['id'] == Game['townId']) {
            var _0xaa01x16 = GPWindowMgr['getByType'](
              GPWindowMgr.TYPE_BUILDING
            );
            for (
              var _0xaa01x17 = 0;
              _0xaa01x16['length'] > _0xaa01x17;
              _0xaa01x17++
            ) {
          ...
          if (_0xaa01x13['Celebration'] != undefined) {
            ConsoleLog.Log(
              '<span style="color: #fff;">' +
                PopupFactory['texts'][
                  _0xaa01x13['Celebration']['celebration_type']
                ] +
                ' is started.</span>',
              2
            );
            _0xaa01x12 =
              _0xaa01x13['Celebration']['finished_at'] - Timestamp['now']();
          }
        } else {
          ConsoleLog.Log(
            Autoculture['town']['name'] + ' ' + _0xaa01x8['json']['error'],
            2
          );
        }
  ...
  contentSettings: function () {
    var _0xaa01x18 =
      '<ul class="game_list" id="townsoverview"><li class="even">';
    _0xaa01x18 +=
    ...
    $['each'](ModuleManager['playerTowns'], function (_0xaa01x19, _0xaa01x6) {
      ...
      _0xaa01x18 +=
        '<div class="wood' +
        (_0xaa01x1d['wood'] == _0xaa01x1d['storage']
          ? ' town_storage_full'
          : '') +
        '">';
      ...
      _0xaa01x18 +=
        '<div class="stone' +
        (_0xaa01x1d['stone'] == _0xaa01x1d['storage']
          ? ' town_storage_full'
          : '') +
        '">';
      ...
      _0xaa01x18 +=
        '<div class="iron' +
        (_0xaa01x1d['iron'] == _0xaa01x1d['storage']
          ? ' town_storage_full'
          : '') +
        '">';
      ...
      _0xaa01x18 += '<div>';
      _0xaa01x18 +=
        '<span class="storage">' + _0xaa01x1d['storage'] + '</span>';
      _0xaa01x18 += '</div>';
      _0xaa01x18 += '</div>';
    ...
    _0xaa01x22['find']('.celebration.party')
      ['mousePopup'](new MousePopup('Auto ' + PopupFactory['texts']['party']))
      ['on']('click', function () {
        _0xaa01x1f('.culture_party_row');
      });
    _0xaa01x22['find']('.celebration.triumph')
      ['mousePopup'](new MousePopup('Auto ' + PopupFactory['texts']['triumph']))
      ['on']('click', function () {
        _0xaa01x1f('.culture_triumph_row');
      });
    _0xaa01x22['find']('.celebration.theater')
      ['mousePopup'](new MousePopup('Auto ' + PopupFactory['texts']['theater']))
      ['on']('click', function () {
        _0xaa01x1f('.culture_theater_row');
      });
    $['each'](ModuleManager['playerTowns'], function (_0xaa01x19, _0xaa01x6) {
      _0xaa01x22['find']('#culture_party_' + _0xaa01x6['id'])['html'](
        FormBuilder['checkbox']({
          id: 'bot_culture_party_' + _0xaa01x6['id'],
          name: 'bot_culture_party_' + _0xaa01x6['id'],
          checked:
            _0xaa01x6['id'] in Autoculture['settings']['towns']
              ? Autoculture['settings']['towns'][_0xaa01x6['id']]['party']
              : false,
          disabled: !Autoculture['checkAvailable'](_0xaa01x6['id'])['party'],
        })
      );
      _0xaa01x22['find']('#culture_triumph_' + _0xaa01x6['id'])['html'](
        FormBuilder['checkbox']({
      ...
      _0xaa01x22['find']('#culture_theater_' + _0xaa01x6['id'])['html'](
        FormBuilder['checkbox']({
    ...
    _0xaa01x22['find']('#bot_culture_settings')
      ['append'](
        FormBuilder['button']({
          name: DM['getl10n']('notes')['btn_save'],
          style: 'float: left;',
        })['on']('click', function () {
          var _0xaa01x23 = $('#bot_townsoverview_table_wrapper input')[
            'serializeObject'
          ]();
          $['each'](
            ModuleManager['playerTowns'],
            function (_0xaa01x19, _0xaa01x6) {
          ...
          $['each'](_0xaa01x23, function (_0xaa01x19, _0xaa01x24) {
            if (_0xaa01x19['indexOf']('bot_culture_party_') >= 0) {
              Autoculture['settings']['towns'][
                _0xaa01x19['replace']('bot_culture_party_', '')
              ]['party'] = _0xaa01x24 != undefined;
            } else {
              if (_0xaa01x19['indexOf']('bot_culture_triumph_') >= 0) {
                Autoculture['settings']['towns'][
                  _0xaa01x19['replace']('bot_culture_triumph_', '')
                ]['triumph'] = _0xaa01x24 != undefined;
              } else {
                if (_0xaa01x19['indexOf']('bot_culture_theater_') >= 0) {
                  Autoculture['settings']['towns'][
                    _0xaa01x19['replace']('bot_culture_theater_', '')
                  ]['theater'] = _0xaa01x24 != undefined;
                }
              }
            }
          });
