ConsoleLog = {
  ...
  Log: function (_message, _type) {
    ...
    var _0x7a76xa =
      _0x7a76x7(_0x7a76x9['getHours']()) +
      ':' +
      _0x7a76x7(_0x7a76x9['getMinutes']()) +
      ':' +
      _0x7a76x7(_0x7a76x9['getSeconds']());
    var _0x7a76xb = $('<div/>')['append'](
      $('<div/>', {
        style: 'width: 100%;',
      })['html'](
        _0x7a76xa + ' - ' + '[' + ConsoleLog['Types'][_type] + ']: ' + _message
      )
    );
  ...
  LogScrollBottom: function () {
    ...
    var _0x7a76x2 = $('.terminal-output');
    if (
      _0x7a76xc['scrollTop']() + _0x7a76xc['height']() ==
      _0x7a76x2['height']()
    ) {
