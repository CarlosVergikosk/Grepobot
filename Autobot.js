var Autobot = {
  ...
  domain:
    ...
    `//cdn.jsdelivr.net/gh/CarlosVergikosk/Grepobot@0.22/`,
  /*    `//3edc-2a04-ee41-83-55a9-4c1-33a7-c0e3-b9a8.eu.ngrok.io/`, */
  botWnd: '',
  isLogged: false,
  Account: {
  ...
  initWnd: function () {
    ...
    if (typeof Autoattack !== 'undefined') {
      _0xe20bx2['find']('.menu_inner li:last-child')['before'](
  ...
  randomize: function (_0xe20bx26, _0xe20bx27) {
    return (
      Math['floor'](Math['random']() * (_0xe20bx27 - _0xe20bx26 + 1)) +
      _0xe20bx26
    );
  },
  secondsToTime: function (_0xe20bx28) {
    ...
    return (
      (_0xe20bx29 ? _0xe20bx29 + ' days ' : '') +
      (_0xe20bx2a ? _0xe20bx2a + ' hours ' : '') +
      (_0xe20bx2b ? _0xe20bx2b + ' minutes ' : '')
    );
  },
  ...
  stringify: function (_0xe20bx37) {
    ...
    for (var _0xe20bx3a in _0xe20bx37) {
      _0xe20bx39['push'](
        '"' + _0xe20bx3a + '":' + this['stringify'](_0xe20bx37[_0xe20bx3a])
      );
    }
  ...
  town_map_info: function (_0xe20bx3b, _0xe20bx3c) {
    if (
      _0xe20bx3b != undefined &&
      _0xe20bx3b['length'] > 0 &&
      _0xe20bx3c['player_name']
    ) {
      for (
        var _0xe20bx3d = 0;
        _0xe20bx3d < _0xe20bx3b['length'];
        _0xe20bx3d++
      ) {
        if (_0xe20bx3b[_0xe20bx3d]['className'] == 'flag town') {
          ...
          $(_0xe20bx3b[_0xe20bx3d])['append'](
            '<div class="player_name">' +
              (_0xe20bx3c['player_name'] || '') +
              '</div>'
          );
          $(_0xe20bx3b[_0xe20bx3d])['append'](
            '<div class="town_name">' + _0xe20bx3c['name'] + '</div>'
          );
          $(_0xe20bx3b[_0xe20bx3d])['append'](
            '<div class="alliance_name">' +
              (_0xe20bx3c['alliance_name'] || '') +
              '</div>'
          );
          break;
        }
  ...
  checkPremium: function (_0xe20bx3e) {
    return $('.advisor_frame.' + _0xe20bx3e + ' div')['hasClass'](
      _0xe20bx3e + '_active'
    );
  },
  initWindow: function () {
  ...
  checkAutoRelogin: function () {
    if (
      ...
      var _0xe20bx40 = $['cookie']('ig_conv_last_site')
